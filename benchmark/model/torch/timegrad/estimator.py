...
class TimeGradEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a TimeGrad model, as described in [SFG17]_.
    ...
    *Note:* the code of this model is unrelated to the implementation behind
    `SageMaker's TimeGrad Forecasting Algorithm
    <https://docs.aws.amazon.com/sagemaker/latest/dg/TimeGrad.html>`_.
    Parameters
    ----------
    freq
