...
class DataEmbedding_wo_pos(nn.Module):
    def __init__(self, target_dim, feat_dim, d_model, dropout=0.1):
        super(DataEmbedding_wo_pos, self).__init__()

        self.value_embedding = TokenEmbedding(c_in=target_dim, d_model=d_model)
        self.temporal_embedding = nn.Linear(feat_dim, d_model, bias=False)
