...
from gluonts.itertools import Cyclic, IterableSlice, PseudoShuffled, Cached
...
from ..utils import InstanceSplitter, SampleForecastGenerator
...
class AutoformerEstimator(PyTorchLightningEstimator):
    ...
    def create_training_data_loader(
        ...
        module: Optional[AutoformerLightningModule] = None,
    ...
    def create_validation_data_loader(
        ...
        **kwargs,
        ...
        transformation = (
            transformation
            + self._create_instance_splitter(module, "validation")
            + SelectFields(module.model.training_input_names, allow_missing=False)
        )
        return DataLoader(
            TransformedIterableDataset(data, transformation),
            batch_size=self.batch_size,
            **kwargs,
        )
